...
@section('content')
    <div class="row col-md-10 mx-auto p-0 d-flex justify-content-end my-5">
        <div class="col-md-1 p-0 d-flex justify-content-end">
            <a href="{{ route('dokter.patients.data') }}" class="d-none d-sm-inline-block btn btn-sm bg-default shadow-sm">
    ...
    <div class="detail-patients container-c row col-md-10">
        ...
        <div class="row">
            ...
            <div class="col-md-6 p-3">
                <span>No. Antrian Obat</span>
                <span class="text-default" style="font-size: 28px">{{ $patient->no_antrian_obat }}</span>
            </div>
