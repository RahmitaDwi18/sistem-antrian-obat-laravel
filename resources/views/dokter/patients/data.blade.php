            ...
            <div class="col-md-12 px-0 py-3 d-flex justify-content-end">
                <a href="/patients/create">
                    <button type="button" class="btn bg-default" title="Tambah Data">
                        <i class="fa-regular fas fa-user-plus"></i> Tambah Antrian Resep
                    </button>
                </a>
            </div>
        @endif --}}
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row justify-content-between">
                    <div class="col-4">
                        <h6 class="m-0 font-weight-bold text-default">Daftar Antrian Obat Pasien</h6>
                    </div>
                            ...
                            <div class="search">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="q"
                                        value="{{ request()->get('q') }}" placeholder="Masukkan kata">
                                        ...
                                        <td class="d-flex justify-content-between">
                                            <a href="{{ route('dokter.patients.edit', $pasien->id) }}">
                                                <button class="btn btn-primary mr-3" title="Edit Data">
                                                    <i class="fa-solid fa-pen-to-square" style="items-center"></i>
                                                </button>
                                            </a>
                                            <a href="{{ route('dokter.patients.show2', $pasien->id) }}">
...
@section('custom_html')
    @foreach ($patients as $pasien)
        <form action="{{ route('dokter.patients.destroy', $pasien->id) }}" id="delete-form-{{ $pasien->id }}"
            method="post">
            @csrf
            @method('DELETE')
        </form>
