...
@section('content')
    ...
    <div class="edit-dokter container-c row col-md-10">
        ...
        <div class="col-md-12 mt-5">
            <form action="{{ route('cs.patients.update', $patient->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_poly" id="poly_name" class="form-control" data-id-poly="{{ $patient->id_poly }}">
                ...
                <div class="col-md-12 d-flex justify-content-end px-0 py-3">
                    <div class="col-md-5 d-flex justify-content-end px-0">
                        <button type="submit" class="btn bg-default">Edit</button>
                    </div>
                </div>
            </form>
        </div>
