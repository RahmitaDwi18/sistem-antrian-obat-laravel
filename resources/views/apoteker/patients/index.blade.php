        ...
        <div class="card-header py-3">
            <div class="row justify-content-between">
                ...
                <div class="row">
                    ...
                    <form class="col-6 ml-3" action="{{ route('search') }}" method="get">
                        <div class="search">
                            <div class="input-group">
                                <input type="text" class="form-control" name="q" value="{{ request()->get('q') }}"
                                    placeholder="Masukkan kata">
                                <div class="input-group-append">
                                    <button class="btn btn-sm btn-info shadow-sm" type="submit">
                        ...
                        <form action="" method="GET">
                            <div class="input-group">
                                <input type="date" class="form-control" name="masuk" id="masuk"
                                    aria-describedby="basic-addon2" @if (!empty($_GET['masuk'])) value={{ $_GET['masuk']
                                    }} @else @endif>
                                <button class="input-group-text text-dark" id="basic-addon2" type="submit">Cari</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <table class="table" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr class="">   
                        ...
                        <td class="text-center" style="font-size: 18px; color:blue">{{ $pasien->no_antrian_obat }}
                        </td>
                        
                        
                        {{-- <th class="text-center" style="font-size: 16pt; color:blue" scope="row">{{ $index + $patients->firstItem() }}</th>                        </td> --}}
                        ...
                        <td class="d-flex justify-content-between">
                            ...
                            <a href="{{ route('apoteker.patients.show', $pasien->id) }}">
                                <button class="btn btn-warning ml-3" title="Lihat Data">
                                    <i class="fa-solid fa-eye"></i>
                                </button>
                            </a>
                        </td>
